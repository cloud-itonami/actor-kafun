...
(ns kafun.methods.kafun-edn
  ...
  Reads the actor's own EDN substrate (data/seed.edn) into Clojure data and
  ...
  data/seed.edn is stored as Datomic/Datascript tx-data (Phase 4 EDN
  ...
  so every downstream caller (src/kafun/cell.cljc, ie_flow.cljc, autorun/digest tests,
